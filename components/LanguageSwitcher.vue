<template>
    <div class="languageSwitcher">
        <button
            @click="select('en')"
            class="bg-white/25 rounded-full py-3 px-4 m-1 text-red-950 border-2 border-red-950 font-medium text-base"
...
.languageSwitcher {
    @apply z-10 fixed right-14 top-5
}
...
.active {
    ...
    color: green;
    border-color: green;
    outline: 2px rgba(173, 255, 47, 0.5) solid;
    outline-offset: 2px;
}
